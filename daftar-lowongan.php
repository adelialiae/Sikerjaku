...
// Mendapatkan kategori dan subkategori dari form
$kategori = isset($_POST['kategori']) ? $_POST['kategori'] : '';
$subkategori = isset($_POST['subkategori']) ? $_POST['subkategori'] : '';

// Membuat query untuk mendapatkan daftar lowongan pekerjaan dengan filter
...
// Menambahkan kondisi filter jika kategori atau subkategori dipilih
$conditions = [];
$params = [];
if ($kategori) {
...
if ($subkategori) {
    $conditions[] = "l.id_subkategori = ?";
    $params[] = $subkategori;
}

if (count($conditions) > 0) {
    $sql_lowongan .= " WHERE " . implode(" AND ", $conditions);
}

$stmt = $conn->prepare($sql_lowongan);
...
$stmt->execute();
$result_lowongan = $stmt->get_result();
?>
...
<body>
    ...
    <div class="content">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="daftar-lowongan.php">
                ...
                <div class="form-group">
                    ...
                    <select id="subkategori" name="subkategori">
                        ...
                        while ($row_subkategori = $result_subkategori->fetch_assoc()) {
                            echo '<option value="' . $row_subkategori['id_subkategori'] . '">' . $row_subkategori['nama_subkategori'] . '</option>';
                        }
                        ?>
                    </select>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="apply_job.php">
                                        <input type="hidden" name="job_id" value="<?php echo $row['kode_loker']; ?>">
                                        <button type="submit" class="btn-apply">Lamar</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endwhile; ?>
