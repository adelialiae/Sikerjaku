...
$sql_pelamar = "SELECT * FROM tbl_pencari_kerja JOIN tbl_loker ON tbl_pencari_kerja.id_subkategori = tbl_loker.id_subkategori WHERE tbl_loker.kode_perusahaan='$user_id'";
    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5">Tidak ada pelamar yang ditemukan.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
